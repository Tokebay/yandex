...
func TestURLShortener_shortenURLHandlerV(t *testing.T) {
	cfg := &config.Config{
	...
	// Создайте экземпляр MapStorage и приведите его к интерфейсу URLStorage.
	storage := storage.NewMapStorage()

	// Создайте экземпляр Producer и передайте его как storage.URLStorage.
